    ...
    <div className="min-h-screen" style={{ background: RC_LIGHT, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-14 rounded-2xl p-8 text-center text-white" style={{ background: `linear-gradient(135deg, ${RC_DARK}, ${RC_NAVY})` }}>
          ...
          <h3 className="text-2xl font-bold mb-3">Big Ships. Real Help. Someone In Your Corner.</h3>
          <p className="mb-6 max-w-lg mx-auto" style={{ color: "#CBD5E1" }}>
            I have sailed Royal Caribbean four times and I am a Platinum Crown and Anchor member. I book Royal on your behalf so you get firsthand knowledge, the right ship for what you are looking for, and someone who actually answers when you have a question. Fill out my form and let's figure out your sailing.
          </p>
          <a
            href={FORM_LINK}
            target="_blank"
