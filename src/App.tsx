...
export const routes: RouteRecord[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'solo', entry: 'src/pages/solo/page.tsx', lazy: () => import('./pages/solo/page').then((m) => ({ Component: m.default })) },
      ...
      { path: 'solo/scarlet-mediterranean-rome-athens-0831', entry: 'src/pages/solo/scarlet-mediterranean-rome-athens-0831/page.tsx', lazy: () => import('./pages/solo/scarlet-mediterranean-rome-athens-0831/page').then((m) => ({ Component: m.default })) },
      { path: 'solo/greek-isles-adriatic-scarlet-0910', entry: 'src/pages/solo/greek-isles-adriatic-scarlet-0910/page.tsx', lazy: () => import('./pages/solo/greek-isles-adriatic-scarlet-0910/page').then((m) => ({ Component: m.default })) },
      ...
      { path: 'solo/alaska-seattle-vancouver-brilliant-0903', entry: 'src/pages/solo/alaska-seattle-vancouver-brilliant-0903/page.tsx', lazy: () => import('./pages/solo/alaska-seattle-vancouver-brilliant-0903/page').then((m) => ({ Component: m.default })) },
      { path: 'solo/mexican-riviera-brilliant-0919', entry: 'src/pages/solo/mexican-riviera-brilliant-0919/page.tsx', lazy: () => import('./pages/solo/mexican-riviera-brilliant-0919/page').then((m) => ({ Component: m.default })) },
