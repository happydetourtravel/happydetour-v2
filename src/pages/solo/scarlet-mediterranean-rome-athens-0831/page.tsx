...
export default function MediterraneanRomeAthensScarlet() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  const days = [
    { day: 1, port: "Rome (Civitavecchia), Italy", time: "Departs 08:00 PM", desc: "Board the Scarlet Lady in Rome and set sail for a ten-night run through Italy and the Greek islands." },
    { day: 2, port: "Florence/Pisa (Livorno), Italy", time: "08:00 AM - 08:00 PM", desc: "Your door into Tuscany. See the Leaning Tower, wander Florence's Duomo, or spend the day in a countryside vineyard." },
    { day: 3, port: "At Sea", time: "", desc: "A sea day heading south along the Italian coast." },
    { day: 4, port: "Amalfi Coast (Salerno), Italy", time: "08:00 AM - 07:00 PM", desc: "Cliffside towns, lemon groves, and some of the most photographed coastline in the world." },
    { day: 5, port: "Catania, Sicily, Italy", time: "10:00 AM - 07:00 PM", desc: "At the foot of Mount Etna, Catania blends baroque architecture with some of the best street food in Italy." },
    { day: 6, port: "At Sea", time: "", desc: "A sea day heading toward Greece." },
    { day: 7, port: "Chania (Souda Bay), Crete, Greece", time: "", desc: "A Venetian harbor town on Crete, with old-town alleys and turquoise water right off the ship." },
    { day: 8, port: "Santorini, Greece", time: "", desc: "Whitewashed cliffside villages and the kind of sunset views that end up on every postcard." },
    { day: 9, port: "Mykonos, Greece", time: "Overnight in port", desc: "Two full days and a night in Mykonos — beach clubs by day, the famous nightlife after dark." },
    { day: 10, port: "Mykonos, Greece", time: "Overnight in port", desc: "A second day to explore Mykonos Town, the windmills, or a quieter beach on the far side of the island." },
    { day: 11, port: "Athens (Piraeus), Greece", time: "Arrives 06:30 AM", desc: "Ten nights through Italy and the Greek islands, ending in Athens." },
  ];
  ...
  const cabins = [
    { type: "Insider", desc: "No window, but everything else you need for an island-hopping itinerary like this one.", price: "$3,458" },
    { type: "Sea View", desc: "A porthole view of the Mediterranean and Aegean as you sail between ports.", price: "$4,658" },
    { type: "Sea Terrace", desc: "Your own private balcony with hammock. Includes bar tab when booked with Eric.", price: "$4,858" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking. Includes bar tab when booked with Eric.", price: "$13,778" },
    { type: "Mega RockStar Quarters", desc: "The largest spaces on the ship, with daily bar tab and spa access.", price: "$19,278" },
  ];

  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/SC-MediterraneanRomeAthens.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Mediterranean: Rome to Athens</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>August 31, 2026</span>
            ...
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Rome to Athens</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Ten nights from Rome to Athens</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Tuscany, the Amalfi Coast, Sicily, Crete, Santorini, and two full days in Mykonos — this is one of the most port-packed Mediterranean itineraries Virgin runs, ending in Athens instead of looping back to Rome.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                Early September still has peak Mediterranean warmth with slightly thinner crowds than August. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$3,458</span>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <a href="https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&currencyCode=USD&dateFrom=2026-08-01&dateTo=2026-08-31&packageCode=10NCA&sailors=1&ships=SC&voyageId=SC26083110NCA" target="_blank" rel="noopener noreferrer" style={{ display: "block", textAlign: "center", color: "#D1D5DB", padding: "6px 16px", textDecoration: "underline", fontWeight: "500", fontSize: "11px", marginBottom: "10px" }}>Already know your cabin? Book directly</a>
