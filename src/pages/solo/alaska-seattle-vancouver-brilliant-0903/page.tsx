...
export default function AlaskaSeattleVancouverBrilliant() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  const days = [
    { day: 1, port: "Seattle, Washington, USA", time: "Departs 05:00 PM", desc: "Board the Brilliant Lady in Seattle and set sail on Virgin's first-ever Alaska season." },
    { day: 2, port: "At Sea", time: "", desc: "A sea day heading north along the Inside Passage." },
    { day: 3, port: "Sitka, Alaska, USA", time: "12:00 PM - 08:00 PM", desc: "Russian history, bald eagles, sea otters, and a harbor that looks like it belongs on a postcard." },
    { day: 4, port: "Icy Strait Point, Alaska, USA", time: "09:00 AM - 06:00 PM", desc: "One of Alaska's most authentic ports — a preserved Tlingit village turned world-class adventure destination. Whale watching and zip lines are all on the table." },
    { day: 5, port: "Skagway, Alaska, USA", time: "07:00 AM - 07:00 PM", desc: "A Gold Rush-era town, with the White Pass railway and glacier hikes right off the ship." },
    { day: 6, port: "Endicott Arm & Dawes Glacier (Cruising), Alaska, USA", time: "", desc: "No port today — just the glacier. A full day cruising past Dawes Glacier, with ice calving into the sea." },
    { day: 7, port: "Ketchikan, Alaska, USA", time: "10:00 AM - 07:00 PM", desc: "Alaska's first city. Known as the Salmon Capital of the World, with totem poles, rainforest, and some of the best seafood you'll find anywhere." },
    { day: 8, port: "At Sea", time: "", desc: "A final sea day heading south toward Vancouver." },
    { day: 9, port: "Vancouver, British Columbia, Canada", time: "Arrives", desc: "Eight nights through Alaska's Inside Passage, ending in one of Canada's most elegant cities." },
  ];

  // Verified solo (per Sailor) pricing pulled directly from Eric's FirstMates affiliate
  // booking tool. Taxes & fees are included in these prices. RockStar Quarters is sold out on this sailing.
  const cabins = [
    { type: "Insider", desc: "No window, but everything else you need on a sailing where you'll spend most of your time on deck watching glaciers.", price: "$1,610" },
    { type: "Sea View", desc: "A porthole window for the Inside Passage. On a sailing this scenic, the upgrade is worth it.", price: "$3,383" },
    { type: "Sea Terrace", desc: "Your own private balcony — watch Dawes Glacier from your room. Includes bar tab when booked with Eric.", price: "$2,432" },
    { type: "RockStar Quarters", desc: "Rooftop access, in-room bar, priority everything. Includes bar tab when booked with Eric.", price: "Sold Out", soldOut: true },
    { type: "Mega RockStar Quarters", desc: "The largest spaces on the ship, with daily bar tab and spa access.", price: "$14,890" },
  ];

  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/BL-Alaska.png')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          <div style={{ display: "flex", gap: "8px", marginBottom: "12px", flexWrap: "wrap" }}>
            ...
            <div style={{ backgroundColor: "#1F2937", color: "white", fontSize: "11px", fontWeight: "800", padding: "4px 10px", borderRadius: "4px", letterSpacing: "1px", textTransform: "uppercase" }}>First Alaska Season</div>
          </div>
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Alaska: Seattle to Vancouver</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>September 3, 2026</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>8 Nights</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Brilliant Lady</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Seattle to Vancouver</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Eight nights through the last great wilderness</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Virgin's first-ever Alaska season, aboard its newest ship. Sitka, Icy Strait Point, Skagway, and Ketchikan, plus a full day cruising past Dawes Glacier — Alaska done with Virgin's signature no-buffet, all-restaurants-included approach.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                Early September is late-season Alaska — cooler, quieter, and still full daylight for glacier viewing. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$1,610</span>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <a href="https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&currencyCode=USD&dateFrom=2026-09-01&dateTo=2026-09-30&packageCode=8NSABC&sailors=1&ships=BR&voyageId=BR2609038NSABC" target="_blank" rel="noopener noreferrer" style={{ display: "block", textAlign: "center", color: "#D1D5DB", padding: "6px 16px", textDecoration: "underline", fontWeight: "500", fontSize: "11px", marginBottom: "10px" }}>Already know your cabin? Book directly</a>
