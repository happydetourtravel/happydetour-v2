...
export default function MexicanRivieraBrilliant() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  const days = [
    { day: 1, port: "Los Angeles, California, USA", time: "Departs 05:00 PM", desc: "Board the Brilliant Lady in Los Angeles and set sail for the Mexican Riviera on Virgin's fall West Coast season." },
    { day: 2, port: "At Sea", time: "", desc: "A sea day heading south along the Baja coast." },
    { day: 3, port: "Cabo San Lucas, Mexico", time: "Arrives 01:00 PM", desc: "The iconic El Arco rock formation, Medano Beach, and a lively marina lined with shops and waterfront dining." },
    { day: 4, port: "Mazatlan, Mexico", time: "09:00 AM - 06:00 PM", desc: "Historic downtown, a long golden malecón, and some of the best seafood on Mexico's Pacific coast." },
    { day: 5, port: "Puerto Vallarta, Mexico", time: "08:00 AM - 05:00 PM", desc: "Cobblestone streets, a lively boardwalk, and beaches ringed by the Sierra Madre mountains." },
    { day: 6, port: "At Sea", time: "", desc: "A sea day heading back north toward California." },
    { day: 7, port: "At Sea", time: "", desc: "A final sea day before arriving back in Los Angeles." },
  ...
  const cabins = [
    { type: "Insider", desc: "No window, but everything else you need for a warm-weather Pacific coast getaway.", price: "$1,452" },
    { type: "Sea View", desc: "A porthole view of the Pacific as you sail between ports.", price: "$1,872" },
    { type: "Sea Terrace", desc: "Your own private balcony with hammock. Includes bar tab when booked with Eric.", price: "$1,774" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking. Includes bar tab when booked with Eric.", price: "$6,911" },
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/BR-MexicanRiviera.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Mexican Riviera</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>September 19, 2026</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Seven nights along the Mexican Riviera</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Cabo San Lucas, Mazatlan, and Puerto Vallarta — three of the Pacific coast's most iconic ports, round trip from Los Angeles on Virgin's newest ship in her first West Coast fall season.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                Late September brings warm water and thinner crowds than peak summer. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$1,452</span>
