...
export default function IcelandGreenlandNycValiant() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  const days = [
    { day: 1, port: "Reykjavik, Iceland", time: "Departs 05:00 PM", desc: "Board the Valiant Lady in Reykjavik and set sail on a transatlantic crossing that only sails once — Virgin's most ambitious itinerary yet." },
    { day: 2, port: "Ísafjörður, Iceland", time: "08:00 AM - 05:00 PM", desc: "A remote fjord town in the Westfjords, known for dramatic landscapes and colorful wooden houses." },
    { day: 3, port: "At Sea", time: "", desc: "A sea day heading toward Greenland." },
    { day: 4, port: "Prince Christian Sound (Cruising), Greenland", time: "", desc: "A full day cruising this narrow fjord in southern Greenland — glaciers, towering cliffs, and floating icebergs, no port stop needed." },
    { day: 5, port: "Qaqortoq, Greenland", time: "08:00 AM - 06:00 PM", desc: "A colorful Greenlandic town between picturesque fjords, home to 18th-century colonial buildings." },
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/VL-IcelandGreenlandNYC.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          <div style={{ display: "flex", gap: "8px", marginBottom: "12px", flexWrap: "wrap" }}>
            ...
            <div style={{ backgroundColor: "#1F2937", color: "white", fontSize: "11px", fontWeight: "800", padding: "4px 10px", borderRadius: "4px", letterSpacing: "1px", textTransform: "uppercase" }}>One-Time Sailing</div>
          </div>
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Iceland, Greenland, Canada & NYC</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>September 6, 2026</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>13 Nights</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Valiant Lady</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Reykjavik to New York</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "16px", backgroundColor: "#1F2937", border: "1px solid #374151", borderRadius: "10px", padding: "18px 20px" }}>
              <p style={{ color: "white", fontWeight: "700", fontSize: "15px", margin: "0 0 4px 0" }}>Sails Once. Ever.</p>
              <p style={{ color: "#D1D5DB", fontSize: "14px", margin: 0, lineHeight: "1.6" }}>
                This exact route — Iceland to Greenland to Canada to New York — is a one-time-only itinerary for the Valiant Lady. It isn't scheduled to repeat.
              </p>
            </div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Thirteen nights from Iceland to Manhattan</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Reykjavik, the Westfjords, a full day cruising Greenland's Prince Christian Sound, Qaqortoq, Nuuk, St. John's, and Halifax — this is nothing like a typical transatlantic crossing. Most of it is port days, not sea days.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                September brings a real shot at the Northern Lights over Greenland and Newfoundland. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
          ...
          <div className="static lg:sticky" style={{ top: "88px" }}>
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <a href="https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&currencyCode=USD&dateFrom=2026-09-01&dateTo=2026-09-30&packageCode=13NRNB&sailors=1&ships=VL&voyageId=VL26090613NRNB" target="_blank" rel="noopener noreferrer" style={{ display: "block", textAlign: "center", backgroundColor: "#CC0000", color: "white", padding: "14px 16px", borderRadius: "8px", textDecoration: "none", fontWeight: "700", fontSize: "15px", marginBottom: "10px" }}>Claim This Solo Spot</a>
