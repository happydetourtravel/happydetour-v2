...
export default function ItalyFrenchRivieraScarlet() {
  ...
  const cabins = [
    ...
    { type: "Sea Terrace", desc: "Your own private balcony with hammock.", price: "$3,023" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking.", price: "$7,704" },
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/SC-ItalyFrenchRiviera.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55) grayscale(0.3)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          <div style={{ display: "flex", gap: "8px", marginBottom: "12px" }}>
            ...
            <div style={{ backgroundColor: "#6B7280", color: "white", fontSize: "11px", fontWeight: "800", padding: "4px 10px", borderRadius: "4px", letterSpacing: "1px", textTransform: "uppercase" }}>Sailed</div>
          </div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Departed Rome</span>
          </div>
        </div>
      </div>
          ...
          <div>
            <div style={{ marginBottom: "32px", backgroundColor: "white", border: "1px solid #E5E7EB", borderRadius: "10px", padding: "18px 20px", display: "flex", gap: "16px", alignItems: "center" }}>
              ...
              <div>
                ...
                <p style={{ color: "#4B5563", fontSize: "13px", margin: 0, lineHeight: "1.5" }}>This particular sailing has already set sail. Take a look below for what a sailing like this includes, and check out currently open dates.</p>
              </div>
            </div>

            <div style={{ marginBottom: "32px", backgroundColor: "#F3F4F6", border: "1px solid #D1D5DB", borderRadius: "10px", padding: "18px 20px" }}>
              <p style={{ color: "#374151", fontWeight: "700", fontSize: "15px", margin: "0 0 4px 0" }}>This sailing has already departed.</p>
              <p style={{ color: "#4B5563", fontSize: "14px", margin: 0, lineHeight: "1.6" }}>
                We're keeping this page up for reference. If you'd like something similar, I can help you find an open sailing with the same route or style.
              </p>
            </div>
                ...
                {days.map((d, i) => (
                  <div key={i} style={{ display: "flex", gap: "20px" }}>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      <div style={{ width: "36px", height: "36px", borderRadius: "50%", backgroundColor: "#9CA3AF", color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "700", fontSize: "13px", flexShrink: 0 }}>{d.day}</div>
          ...
          <div className="static lg:sticky" style={{ top: "88px" }}>
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#374151", padding: "16px 20px" }}>
                <p style={{ color: "#D1D5DB", fontSize: "11px", fontWeight: "700", letterSpacing: "1px", textTransform: "uppercase", margin: "0 0 4px 0" }}>This Sailing Has Departed</p>
                <p style={{ color: "white", fontSize: "16px", fontWeight: "600", margin: "6px 0 0 0", lineHeight: "1.5" }}>Bookings are closed for this date.</p>
                <p style={{ color: "#9CA3AF", fontSize: "12px", margin: "10px 0 0 0", lineHeight: "1.5" }}>Reach out and I'll help you find a similar open sailing.</p>
              </div>
              <div style={{ padding: "20px" }}>
                <p style={{ color: "#374151", fontSize: "13px", fontWeight: "600", margin: "0 0 12px 0" }}>Cabin Categories (as sailed)</p>
                  ...
                  {cabins.map((c, i) => (
                    <div key={i} style={{ borderBottom: i < cabins.length - 1 ? "1px solid #F3F4F6" : "none", paddingBottom: i < cabins.length - 1 ? "10px" : "0" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2px" }}>
                        ...
                        <span style={{ color: "#9CA3AF", fontWeight: "700", fontSize: "14px" }}>{c.price}</span>
                      </div>
                      <p style={{ color: "#9CA3AF", fontSize: "12px", margin: 0, lineHeight: "1.5" }}>{c.desc}</p>
                    </div>
                  ))}
                </div>
                <a href="/solo" style={{ display: "block", textAlign: "center", backgroundColor: "#007298", color: "white", padding: "14px 16px", borderRadius: "8px", textDecoration: "none", fontWeight: "700", fontSize: "15px", marginBottom: "10px" }}>See Currently Open Sailings</a>
                <a href="mailto:eric@happydetour.com" style={{ display: "block", textAlign: "center", backgroundColor: "#F9FAFB", color: "#007298", padding: "10px 16px", borderRadius: "8px", fontWeight: "600", fontSize: "13px", border: "1px solid #E5E7EB", textDecoration: "none", marginBottom: "10px" }}>Ask Eric About a Similar Trip</a>
                <p style={{ color: "#9CA3AF", fontSize: "11px", textAlign: "center", margin: 0, lineHeight: "1.5" }}>Pricing shown reflects this sailing as offered and is no longer bookable.</p>
