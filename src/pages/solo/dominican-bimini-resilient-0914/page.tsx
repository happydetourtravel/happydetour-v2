...
export default function DominicanBiminiResilientSep14() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  const days = [
    { day: 1, port: "Miami, Florida, USA", time: "Departs 05:00 PM", desc: "Step aboard the Resilient Lady in Miami and kick off a five-night run through the Dominican Republic and Virgin's private Bimini island." },
    { day: 2, port: "At Sea", time: "", desc: "A slow, easy sea day to settle into the ship before your first port." },
    { day: 3, port: "Puerto Plata, Dominican Republic", time: "10:00 AM - 07:00 PM", desc: "Cobblestone streets, beachside cafés, and a cable car ride up Mount Isabel de Torres for sweeping views." },
    { day: 4, port: "At Sea", time: "", desc: "Another sea day heading toward the Bahamas." },
    { day: 5, port: "The Beach Club at Bimini, Bahamas", time: "09:00 AM - 07:00 PM", desc: "A full day at Virgin's private island — turquoise water, DJ sets, and Bahamian-inspired food right on the beach." },
    { day: 6, port: "Miami, Florida, USA", time: "Arrives 06:30 AM", desc: "Five nights in the Caribbean, wrapped up and back in Miami by morning." },
  ];

  // Verified solo pricing pulled directly from Eric's FirstMates affiliate booking tool
  // (shown as per-cabin total for solo occupancy). Taxes & fees are included.
  // RockStar Quarters and Mega RockStar Quarters are sold out on this sailing.
  const cabins = [
    { type: "Insider", desc: "No window, but everything else you need for a quick Caribbean reset.", price: "$1,397" },
    { type: "Sea View", desc: "A porthole view of the Caribbean as you sail between ports.", price: "$1,497" },
    { type: "Sea Terrace", desc: "Your own private balcony with hammock.", price: "$1,696" },
  ];
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Dominican Republic & Bimini Beach Club</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>September 14, 2026</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>5 Nights</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>A quick Caribbean reset, mid-September</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Same great route as peak summer, without the peak summer crowds or price. Puerto Plata for a full day in the Dominican Republic, then a day at Virgin's exclusive Beach Club in Bimini, all from a short Miami round trip.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                Mid-September is shoulder season in the Caribbean — still warm, noticeably quieter. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$1,397</span>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <a href="https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&currencyCode=USD&dateFrom=2026-09-01&dateTo=2026-09-30&packageCode=5NPP&priceType=perCabin&sailors=1&ships=RS&voyageId=RS2609145NPP" target="_blank" rel="noopener noreferrer" style={{ display: "block", textAlign: "center", color: "#D1D5DB", padding: "6px 16px", textDecoration: "underline", fontWeight: "500", fontSize: "11px", marginBottom: "10px" }}>Already know your cabin? Book directly</a>
