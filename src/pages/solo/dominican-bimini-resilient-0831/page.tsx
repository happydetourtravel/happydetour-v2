...
export default function DominicanBiminiResilientAug31() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  const days = [
    { day: 1, port: "Miami, Florida, USA", time: "Departs 05:00 PM", desc: "Board the Resilient Lady in Miami and set sail for the Dominican Republic and Virgin's private island in Bimini." },
    { day: 2, port: "At Sea", time: "", desc: "A sea day heading toward the Dominican Republic." },
    { day: 3, port: "Puerto Plata, Dominican Republic", time: "10:00 AM - 07:00 PM", desc: "Colorful Victorian architecture, the Malecón promenade, and a cable car ride up Mount Isabel de Torres for panoramic views." },
    { day: 4, port: "At Sea", time: "", desc: "A sea day heading toward the Bahamas." },
    { day: 5, port: "The Beach Club at Bimini, Bahamas", time: "09:00 AM - 07:00 PM", desc: "Virgin's private island resort — DJ sets led by Mark Ronson's crew, Bahamian food, and beach clubs right on the sand." },
    { day: 6, port: "Miami, Florida, USA", time: "Arrives 06:30 AM", desc: "Five nights of Caribbean island-hopping, done the Virgin way." },
  ];
  ...
  // Insider, Sea View, and Mega RockStar are sold out on this sailing.
  const cabins = [
    { type: "Insider", desc: "No window, but everything else you need for a short, easy Caribbean getaway.", price: "Sold Out", soldOut: true },
    { type: "Sea View", desc: "A porthole view of the Caribbean as you sail between ports.", price: "Sold Out", soldOut: true },
    { type: "Sea Terrace", desc: "Your own private balcony with hammock. Includes bar tab when booked with Eric.", price: "$1,788" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking. Includes bar tab when booked with Eric.", price: "$3,228" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Five nights of easy Caribbean island-hopping</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                A short, low-lift getaway from Miami — Puerto Plata in the Dominican Republic, then a full day at Virgin's exclusive Beach Club in Bimini, before heading back to Miami. Perfect if you want a real vacation without burning a big chunk of vacation days.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                Late August is warm, easy Caribbean weather. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$1,788</span>
