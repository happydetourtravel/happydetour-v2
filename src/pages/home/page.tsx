...
const featuredDeals = [
  ...
  { tag: "VIRGIN VOYAGES", title: "Eastern Caribbean & Bimini Beach Club", date: "Mar 2027", nights: "7 nights", ship: "Resilient Lady · Miami", originalPrice: "$1,399", salePrice: "$1,099", link: "/contact" },
  { tag: "VIRGIN VOYAGES", title: "Southern Caribbean — Aruban Nights", date: "Jun 2027", nights: "7 nights", ship: "Scarlet Lady · San Juan", originalPrice: "$1,599", salePrice: "$1,249", link: "/contact" },
            ...
            {cruiseLines.map((line) => (
              <div key={line.name} style={{ position: 'relative', overflow: 'hidden', borderRadius: '16px' }}>
                ...
                <div style={{ backgroundColor: 'white', borderRadius: '16px', padding: '24px', border: '1px solid #F3F4F6', display: 'flex', flexDirection: 'column', gap: '12px', opacity: line.live ? 1 : 0.6, height: '100%' }}>
                  ...
                  {line.live && <a href="/cruises" style={{ color: '#007298', fontSize: '14px', fontWeight: '600', textDecoration: 'none' }}>View sailings</a>}
                </div>
              </div>
            ))}
          </div>
