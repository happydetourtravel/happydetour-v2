...
export default function SouthernCaribbeanNov() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  // Confirmed day-by-day from Virgin Voyages' own itinerary page.
  const days = [
    { day: 1, port: "San Juan, Puerto Rico, USA", time: "Departs 08:00 PM", desc: "Board the Valiant Lady in San Juan and set sail for the Southern Caribbean." },
    { day: 2, port: "Charlotte Amalie, St. Thomas, U.S. Virgin Islands", time: "08:00 AM - 06:00 PM", desc: "Duty-free shopping, gorgeous beaches, and a classic Caribbean port day." },
    { day: 3, port: "At Sea", time: "", desc: "A sea day heading toward Curaçao." },
    { day: 4, port: "Willemstad, Curaçao", time: "09:00 AM - 07:00 PM", desc: "Colorful Dutch colonial architecture and some of the clearest water in the Caribbean." },
    { day: 5, port: "Oranjestad, Aruba", time: "09:00 AM - 10:00 PM", desc: "A long day and evening on one of the Caribbean's most reliably sunny islands." },
    { day: 6, port: "At Sea", time: "", desc: "A sea day heading back north." },
    { day: 7, port: "Basseterre, St. Kitts and Nevis", time: "08:00 AM - 06:00 PM", desc: "Colonial architecture, volcanic peaks, and a compact, walkable port town." },
    { day: 8, port: "Philipsburg, St. Maarten", time: "08:00 AM - 05:00 PM", desc: "A vibrant, eclectic port for beach time, shopping, and outdoor adventure." },
    { day: 9, port: "San Juan, Puerto Rico, USA", time: "Arrives 06:30 AM", desc: "Eight nights through the Southern Caribbean, done the Virgin way." },
  ];

  // Verified per-sailor pricing pulled directly from Virgin Voyages / Eric's
  // FirstMates tool. Taxes & fees included.
  const cabins = [
    { type: "Insider", desc: "Roomy rainshower, mood lighting, glam station, large flat screen TV.", price: "$792" },
    { type: "Sea View", desc: "Porthole window for ocean views, roomy rainshower, mood lighting.", price: "$872" },
    { type: "Sea Terrace", desc: "Private balcony with hammock, roomy rainshower, mood lighting.", price: "$952" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking.", price: "$4,072" },
    { type: "Mega RockStar Quarters", desc: "Largest interior/exterior spaces, daily bar tab & spa access, bottomless in-room bar.", price: "$6,552" },
  ];

  const bookingUrl = "https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&currencyCode=USD&dateFrom=2026-11-01&dateTo=2026-11-30&packageCode=8NSJC&ships=VL&voyageId=VL2611208NSJC";

  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/SanJuanCouple.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Southern Caribbean Cruise</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>November 20, 2026</span>
            ...
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Departs San Juan</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Eight nights through the Southern Caribbean</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Round trip from San Juan with five islands in eight nights — St. Thomas, Curaçao, Aruba, St. Kitts, and St. Maarten — a real island-hopping itinerary.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                Lots of port time and only two sea days built in, so this one's for people who want to be off the ship exploring more than relaxing onboard. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$792</span>
