...
export default function BermudaCaribbeanNYCSanJuan() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  // Confirmed day-by-day from Virgin Voyages' own itinerary page.
  const days = [
    { day: 1, port: "New York City, New York, USA", time: "Departs 05:00 PM", desc: "Board the Valiant Lady in New York and set sail for Bermuda and the Caribbean." },
    { day: 2, port: "At Sea", time: "", desc: "A sea day heading toward Bermuda." },
    { day: 3, port: "Royal Naval Dockyard, Bermuda", time: "Arrives 04:00 PM", desc: "The first of two full days in Bermuda — pink sand beaches, museums, and boutique shopping." },
    { day: 4, port: "Royal Naval Dockyard, Bermuda", time: "Departs 04:00 PM", desc: "A second day to explore Bermuda before sailing on toward the Caribbean." },
    { day: 5, port: "At Sea", time: "", desc: "A sea day heading south." },
    { day: 6, port: "At Sea", time: "", desc: "A second sea day before arriving at Bimini." },
    { day: 7, port: "The Beach Club at Bimini, Bahamas", time: "08:00 AM - 06:00 PM", desc: "A full day at Virgin's private beach club — powder-white sand, swim-up bars, and beachside relaxation." },
    { day: 8, port: "At Sea", time: "", desc: "A sea day heading toward the U.S. Virgin Islands." },
    { day: 9, port: "At Sea", time: "", desc: "A second sea day before arriving at St. Croix." },
    { day: 10, port: "St. Croix, U.S. Virgin Islands", time: "09:00 AM - 06:00 PM", desc: "Lush rainforests, a rich pirate history, and some of the Caribbean's best rum." },
    { day: 11, port: "Philipsburg, St. Maarten", time: "08:00 AM - 06:00 PM", desc: "A vibrant, eclectic port for beach time, shopping, and outdoor adventure." },
    { day: 12, port: "Tortola, British Virgin Islands", time: "08:00 AM - 06:00 PM", desc: "Home to The Baths — famous granite boulder formations and hidden coves." },
    { day: 13, port: "San Juan, Puerto Rico, USA", time: "Arrives 06:30 AM", desc: "Twelve nights from New York to San Juan, done the Virgin way." },
  ];

  // Verified per-sailor pricing pulled directly from Virgin Voyages / Eric's
  // FirstMates tool. Taxes & fees included.
  const cabins = [
    { type: "Insider", desc: "Roomy rainshower, mood lighting, glam station, large flat screen TV.", price: "$1,188" },
    { type: "Sea View", desc: "Porthole window for ocean views, roomy rainshower, mood lighting.", price: "$1,308" },
    { type: "Sea Terrace", desc: "Private balcony with hammock, roomy rainshower, mood lighting.", price: "$1,308" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking.", price: "$4,308" },
    { type: "Mega RockStar Quarters", desc: "Largest interior/exterior spaces, daily bar tab & spa access, bottomless in-room bar.", price: "$7,188" },
  ];

  const bookingUrl = "https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&bookingChannel=FMLINK&cabins=1&currencyCode=USD&dateFrom=2026-10-01&dateTo=2026-10-31&durations=9-12&packageCode=12NNBSL&ships=VL&voyageId=VL26101912NNBSL";

  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/VL-BritishVirginIslands.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.55)" }} />
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Bermuda & Caribbean: NYC to San Juan</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>October 19, 2026</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>12 Nights</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Valiant Lady</span>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>Departs New York</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Twelve nights from New York to San Juan</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Two full days in Bermuda's pink-sand paradise, a day at Virgin's private Beach Club at Bimini, then on to St. Croix, St. Maarten, and Tortola before ending in the vibrant streets of San Juan.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                This one-way repositioning sailing covers more ground than a typical Caribbean week, with plenty of sea days built in to relax between ports. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$1,188</span>
