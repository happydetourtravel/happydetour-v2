...
export default function EasternCaribbeanBiminiNov() {
  const [contactOpen, setContactOpen] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);

  // Confirmed day-by-day from Virgin Voyages' own itinerary page.
  const days = [
    { day: 1, port: "Miami, Florida, USA", time: "Departs 05:00 PM", desc: "Board the Brilliant Lady in Miami and set sail for the Eastern Caribbean." },
    { day: 2, port: "At Sea", time: "", desc: "A sea day heading toward St. Maarten." },
    { day: 3, port: "At Sea", time: "", desc: "A second sea day." },
    { day: 4, port: "Philipsburg, St. Maarten", time: "08:00 AM - 06:00 PM", desc: "A vibrant, eclectic port for beach time, shopping, and outdoor adventure." },
    { day: 5, port: "Tortola, British Virgin Islands", time: "09:00 AM - 06:00 PM", desc: "Home to The Baths — famous granite boulder formations and hidden coves." },
    { day: 6, port: "Basseterre, St. Kitts and Nevis", time: "08:00 AM - 06:00 PM", desc: "Colonial architecture, volcanic peaks, and a compact, walkable port town." },
    { day: 7, port: "St. John's, Antigua", time: "08:00 AM - 05:00 PM", desc: "365 beaches — one for every day of the year — and a laid-back Caribbean charm." },
    { day: 8, port: "At Sea", time: "", desc: "A sea day heading back toward the Bahamas." },
    { day: 9, port: "At Sea", time: "", desc: "A second sea day before Bimini." },
    { day: 10, port: "The Beach Club at Bimini, Bahamas", time: "09:00 AM - 06:00 PM", desc: "A full day at Virgin's private beach club — powder-white sand, swim-up bars, and beachside relaxation." },
    { day: 11, port: "Miami, Florida, USA", time: "Arrives 06:30 AM", desc: "Ten nights through the Eastern Caribbean, done the Virgin way." },
  ];

  // Verified per-sailor pricing pulled directly from Virgin Voyages / Eric's
  // FirstMates tool. Taxes & fees included. Sea Terrace is priced below
  // Insider and Sea View on this specific sailing — confirmed accurate.
  const cabins = [
    { type: "Sea Terrace", desc: "Private balcony with hammock, roomy rainshower, mood lighting.", price: "$1,190" },
    { type: "Insider", desc: "Roomy rainshower, mood lighting, glam station, large flat screen TV.", price: "$1,436" },
    { type: "Sea View", desc: "Porthole window for ocean views, roomy rainshower, mood lighting.", price: "$1,532" },
    { type: "RockStar Quarters", desc: "Exclusive Richard's Rooftop access, stocked in-room bar, priority booking.", price: "$4,090" },
    { type: "Mega RockStar Quarters", desc: "Largest interior/exterior spaces, daily bar tab & spa access, bottomless in-room bar.", price: "$6,990" },
  ];

  const bookingUrl = "https://www.virginvoyages.com/book/voyage-planner/pre-checkout?agencyId=589&agentId=278796&currencyCode=USD&dateFrom=2026-11-01&dateTo=2026-11-30&packageCode=10NMM&ships=BR&voyageId=BR26111510NMM";
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div className="h-[320px] md:h-[480px]" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="px-4 md:px-6 pb-8 md:pb-12" style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <h1 className="text-[28px] md:text-[42px]" style={{ color: "white", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Eastern Caribbean & Bimini Beach Club</h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,0.9)", fontSize: "15px" }}>November 15, 2026</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 lg:gap-12" style={{ alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ color: "#1F2937", fontSize: "28px", fontWeight: "800", margin: "0 0 16px 0" }}>Ten nights through the Eastern Caribbean</h2>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>
                Round trip from Miami with four islands in a row — St. Maarten, Tortola, St. Kitts, and Antigua — then a full day at Virgin's private Beach Club at Bimini before heading home.
              </p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>
                A longer, more port-heavy week than a typical Caribbean sailing, great for anyone who wants to see more islands in one trip. All specialty restaurants, WiFi, and fitness classes are included. Gratuities are paid onboard separately.
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              <div style={{ backgroundColor: "#1F2937", padding: "16px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span style={{ color: "white", fontSize: "36px", fontWeight: "800" }}>$1,190</span>
