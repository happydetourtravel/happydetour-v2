  ...
  return (
    <div className="border border-teal-100 rounded-xl overflow-hidden mb-3">
      <button
        ...
        className="w-full flex justify-between items-center px-6 py-4 text-left font-semibold text-gray-800 hover:bg-teal-50 transition-colors"
      ...
      {open && (
        <div className="px-6 py-5 bg-white border-t border-teal-100 text-gray-700 leading-relaxed">
          {children}
        </div>
      )}
    </div>
    ...
    <div className="min-h-screen" style={{ background: B_LIGHT, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto">
          <p className="text-sm uppercase tracking-widest mb-3" style={{ color: "#7EEEE8" }}>Family All-Inclusive</p>
          <h1 className="text-5xl font-bold mb-4 leading-tight">Beaches Resorts</h1>
          <p className="text-xl mb-6 leading-relaxed" style={{ color: "#C0F0EE" }}>
          ...
          <p className="text-base" style={{ color: "#90D8D4" }}>
      ...
      {/* Tab Bar */}
      <div className="sticky top-0 z-30 shadow-md overflow-x-auto" style={{ background: B_DARK }}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {activeTab === "about" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>About Beaches Resorts</h2>
            <p className="text-gray-500 mb-8">Beaches is the family brand under the same umbrella as Sandals. Same Luxury Included philosophy, same commitment to truly all-inclusive, but built from the ground up to work for families of all shapes and sizes rather than just couples.</p>
            ...
            <Accordion title="What Is Beaches?">
              ...
              <p>The result is a resort brand that solves the hardest problem in family travel. Making everyone actually happy at the same time.</p>
            </Accordion>
            ...
            <Accordion title="Who Is Beaches For?">
              ...
              <ul className="list-disc pl-5 space-y-2 mb-3">
                ...
                <li>Groups of families traveling together who want a property big enough to accommodate everyone</li>
            ...
            <Accordion title="How Beaches Differs From a Regular All-Inclusive">
              ...
              <ul className="list-disc pl-5 space-y-2 mb-3">
                ...
                <li>Sesame Street character experiences built into the resort experience</li>
            ...
            <Accordion title="Why Book Through Eric?">
              <p className="mb-3">You get the same Beaches price through Eric's link as you do booking direct. What you also get is someone who has researched every property, understands how to match families to the right resort based on the ages of their kids and what they want from the trip, and is available before and during your vacation if anything comes up.</p>
        ...
        {activeTab === "resorts" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>The Beaches Properties</h2>
            <p className="text-gray-500 mb-8">Beaches currently operates two flagship properties with several new locations in development. Here is what is available now and what is coming.</p>

            <div className="p-4 rounded-xl mb-6 text-sm" style={{ background: B_ACCENT, borderLeft: `4px solid ${B_TEAL}` }}>
              <strong>Expansion note:</strong> Beaches is actively growing. New properties including Beaches St. Vincent, Beaches Turks and Caicos expansion, Beaches Runaway Bay Jamaica, Beaches Barbados, and Beaches Exuma Bahamas are in development or opening soon. Beaches Ocho Rios closed in May 2025 for major renovations as part of this expansion. Reach out to Eric for the latest availability before you book.
            </div>
            ...
            <Accordion title="Beaches Turks and Caicos — The Flagship">
              ...
              <p className="mb-3">The numbers alone give you a sense of the scale: 45,000 square foot waterpark, 20 specialty restaurants, 12 miles of beach, 10 pools, and one of the most beautiful stretches of turquoise water in the Caribbean. Families consistently describe it as the best vacation they have ever taken.</p>
              <ul className="list-disc pl-5 space-y-2 mt-4 text-sm">
                <li><strong>Location:</strong> Grace Bay, Providenciales, Turks and Caicos</li>
                <li><strong>Airport:</strong> Providenciales International, about 6 miles from the resort</li>
            ...
            <Accordion title="Beaches Negril — Jamaica">
              ...
              <p className="mb-3">Negril as a destination has a famously relaxed vibe and spectacular sunsets. Beaches Negril captures that energy while delivering the full Beaches programming and amenities families expect from the brand.</p>
              <ul className="list-disc pl-5 space-y-2 mt-4 text-sm">
            ...
            <Accordion title="Coming Soon — New Beaches Properties">
              <p className="mb-3">Beaches is in active expansion mode. Properties currently in development or recently announced include:</p>
        ...
        {activeTab === "included" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>What's Included</h2>
            <p className="text-gray-500 mb-8">Beaches follows the same Luxury Included philosophy as Sandals. Here is the complete picture of what comes with your family's stay.</p>
            ...
            <Accordion title="All Dining — Every Restaurant">
              ...
              <p>Kids menus are available at every restaurant and the resort knows how to handle the full range of family dining needs from picky eaters to adventurous ones.</p>
            </Accordion>

            <Accordion title="The Waterpark — Fully Included">
              <p className="mb-3">The waterpark is fully included for all guests. At Beaches Turks and Caicos the waterpark covers 45,000 square feet with multiple slides, a lazy river, splash zones for little kids, and bigger thrills for older kids and teens. No wristband purchase, no per-slide fees. It is part of your stay.</p>
            ...
            <Accordion title="Kids Clubs and Programming">
              ...
              <p>The kids clubs run throughout the day and into the evening allowing parents to have dinner alone or spend time at the adult pool without feeling guilty about what the kids are doing.</p>
            </Accordion>
            ...
            <Accordion title="Water Sports and Scuba">
              ...
              <p>This is a significant value for families who want water activity variety beyond the pool and beach without paying separately for equipment rentals throughout the trip.</p>
            </Accordion>
            ...
            <Accordion title="Airport Transfers and No Tipping">
              ...
              <p>Beaches follows the same no-tipping policy as Sandals resort-wide. The staff are compensated well and no gratuities are expected at any point during your stay.</p>
            </Accordion>
        ...
        {activeTab === "dining" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>Dining at Beaches</h2>
            <p className="text-gray-500 mb-8">The dining program at Beaches is one of the most impressive in family resort travel. Multiple specialty restaurants, dedicated kids menus, and a quality level that makes parents genuinely happy rather than just adequately fed.</p>
            ...
            <Accordion title="The Buffet">
              <p>The main buffet at Beaches runs for most of the day and is the casual go-to for breakfast, quick lunches, and late-night snacks. The variety is broad and the quality is above what most family resorts offer at their buffet stations. A great option when the family is between activities and just needs fuel.</p>
            </Accordion>
            ...
            <Accordion title="Dining Reservations">
              ...
              <p>The resort concierge can help with reservations and can also accommodate families with specific dietary needs, allergies, or preferences. Let them know upfront and they will make sure the kitchen is prepared.</p>
            </Accordion>

            <Accordion title="Late Night and Room Service">
              <p>Room service is available at Beaches resorts and is a genuinely useful option for families traveling with young kids who need an early dinner or a snack after a long activity day. Being able to order to your room without packing up the whole family is one of those conveniences that makes the trip smoother.</p>
            </Accordion>
          </section>
        )}
        ...
        {activeTab === "activities" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>Activities for the Whole Family</h2>
            <p className="text-gray-500 mb-8">The activity program at Beaches is one of the things that separates it from every other family resort. There is genuinely something for every age at every level of energy at all times.</p>
            ...
            <Accordion title="Scuba Diving and Snorkeling">
              ...
              <p>PADI certification courses are available for teens and adults who want to get certified during their stay. A memorable family experience that comes home with you long after the tan fades.</p>
            </Accordion>
            ...
            <Accordion title="Land Sports and Fitness">
              <p>Tennis courts, beach volleyball, basketball, and a fully equipped fitness center are all included. Group fitness classes are available for adults who want to keep up a routine even on vacation. Evening entertainment includes live music, cultural shows, and family-friendly performances throughout the week.</p>
            </Accordion>
            ...
            <Accordion title="Off-Resort Excursions">
              ...
              <p>Book excursions early on arrival day. Popular family excursions sell out during peak weeks and there is nothing worse than telling kids the activity they were looking forward to is no longer available.</p>
            </Accordion>
          </section>
        )}
        ...
        {activeTab === "kids" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>Kids and Teens at Beaches</h2>
            <p className="text-gray-500 mb-8">This is where Beaches separates itself from every other family resort brand. The kids programming is not an afterthought. It is a core part of the resort experience built specifically for every age group.</p>

            <Accordion title="Camp Sesame — Little Ones">
              <p className="mb-3">Camp Sesame is Beaches' dedicated program for young children featuring Sesame Street character interactions, supervised play, structured activities, and themed experiences throughout the day. It is designed for kids from toddlers through early elementary age.</p>
              <p className="mb-3">The staff-to-child ratio is high and the programming changes throughout the day so kids are genuinely engaged rather than just supervised. Parents consistently report that their young kids asked to go back to Camp Sesame every day of the trip.</p>
            ...
            <Accordion title="The Sesame Street Character Experience">
              ...
              <p>For families with children in the Sesame Street age range this is genuinely one of the most magical parts of the trip. The characters are accessible and the interactions are warm rather than rushed. Young kids who have grown up watching Sesame Street meeting those characters in person at the beach is a memory that sticks.</p>
            </Accordion>

            <Accordion title="Tweens — Ages 9 to 12">
              <p className="mb-3">Beaches has a dedicated tween program with activities and spaces designed specifically for the age group that is too old for Camp Sesame and too young to just hang out at the beach bar. The tween program includes supervised activities, beach games, water sports instruction, and social events where kids in the same age group can meet each other.</p>
            ...
            <Accordion title="Teens — Their Own Space">
              <p className="mb-3">The teen program at Beaches gives older kids their own dedicated spaces and activities separate from the little kids. Xbox gaming lounges where teens can hang out and game, a teen-specific social program, access to the full waterpark, water sports, and evening entertainment designed for their age group.</p>
              ...
              <p>The consistent feedback from families traveling with teens is that they were skeptical going in and the teens ended up having the best time of the trip. Beaches takes the teen experience seriously enough that the kids actually enjoy it.</p>
            </Accordion>

            <Accordion title="Xbox Lounge">
              <p>Every Beaches property has a dedicated Xbox gaming lounge with consoles and games available for kids and teens. A great option on rainy afternoons or when kids need a break from the sun. It is fully included and gives kids who are less beach-oriented something they genuinely enjoy doing on vacation.</p>
            </Accordion>
            ...
            <Accordion title="What About Babies and Infants?">
              ...
              <p>Traveling with a very young baby to an all-inclusive resort is a significant undertaking but Beaches does more to support it than most resorts. The beach setting, the pool shallows, and the included childcare give parents options that most resorts do not.</p>
            </Accordion>
          </section>
        )}
        ...
        {activeTab === "insurance" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>Trip Insurance</h2>
            <p className="text-gray-500 mb-8">Trip insurance is even more important on a family trip than on a couples getaway. More people means more variables. One sick kid can affect the whole trip. This is the coverage that protects your family vacation investment.</p>

            <div className="p-5 rounded-xl mb-6 text-white text-sm" style={{ background: B_DARK }}>
            ...
            <Accordion title="What If Someone Gets Sick Before You Leave?">
              ...
              <p>Trip cancellation coverage for covered medical reasons means you cancel, get reimbursed, and rebook when everyone is healthy. Family trips are expensive enough that losing the full amount is a real financial hit.</p>
            </Accordion>
            ...
            <Accordion title="What If Someone Gets Sick or Hurt at the Resort?">
              ...
              <p>Medical coverage in your trip insurance means the care is covered regardless of where you are. For families especially, having that protection in place is not optional.</p>
            </Accordion>

            <Accordion title="What If Flights Get Disrupted?">
              <p>Traveling with kids and a cancelled flight is one of the most stressful experiences in family travel. Trip delay coverage helps cover the hotel, meals, and rebooking costs when your travel falls apart before you reach the resort. It turns a nightmare scenario into a manageable inconvenience.</p>
            </Accordion>
        ...
        {activeTab === "tips" && (
          <section>
            <h2 className="text-3xl font-bold mb-2" style={{ color: B_DARK }}>Eric's Tips for Your Beaches Stay</h2>
            <p className="text-gray-500 mb-8">These tips come from extensive research including verified guest reviews, travel advisor communities, and direct feedback from families who have stayed at Beaches properties. They are the things people consistently wish they had known before they arrived.</p>
            ...
            <Accordion title="Book Dining Reservations Early — On Arrival Day">
              ...
              <p>With kids you also want to think about timing. Early evening seatings tend to work better for younger children. Book the times that work for your family rather than what is leftover after other guests have claimed the good slots.</p>
            </Accordion>

            <Accordion title="Get to the Waterpark Early">
              <p className="mb-3">The waterpark gets crowded as the day progresses. Families who get there right when it opens have significantly shorter wait times for the most popular slides and claim the best spots at the lazy river and splash areas.</p>
              <p>A good strategy is waterpark in the morning when it is less crowded, beach and pool in the afternoon when the sun is lower, and dinner and evening entertainment to close the day.</p>
            </Accordion>
            ...
            <Accordion title="Tell the Resort About Special Occasions and Needs">
              ...
              <p>Tell Eric when you book and he will make sure the resort is flagged. Surprises on arrival day with kids in tow are the last thing you want to deal with.</p>
            </Accordion>
            ...
            <Accordion title="Let the Kids Club Do Its Job">
              ...
              <p>The consistent feedback from families is that their children asked to go back to the kids club every day. Use the time to enjoy the adult pool, have a long lunch, or just sit on the beach without managing anyone. That is a vacation for you too.</p>
            </Accordion>
            ...
            <Accordion title="Pack Sun Protection Seriously">
              <p className="mb-3">The Caribbean sun is significantly stronger than what most families from the mainland are used to. Reef-safe sunscreen is required at Beaches properties to protect the marine environment. Pack enough for the whole trip because resort retail prices for sunscreen are high.</p>
              <p>Start with sunscreen on the first day even if it is overcast. The reflection off the water and sand means sun exposure is significant even when it does not feel like it. Kids burn faster than adults in this environment.</p>
            </Accordion>
            ...
            <Accordion title="Get Trip Insurance — It Matters More With Kids">
              <p>More people means more variables. One sick kid can affect the whole trip. Medical situations abroad are more complicated with children involved. Lock in trip insurance at booking when it is cheapest and you have full coverage. Do not leave home without it especially when the whole family is involved.</p>
            </Accordion>
          </section>
        )}

        {/* CTA */}
        <div className="mt-14 rounded-2xl p-8 text-center text-white" style={{ background: `linear-gradient(135deg, ${B_DARK}, ${B_TEAL})` }}>
          <p className="text-sm uppercase tracking-widest mb-2" style={{ color: "#7EEEE8" }}>Ready for the Family Trip</p>
          <h3 className="text-2xl font-bold mb-3">Let's Find Your Perfect Beaches Resort</h3>
          <p className="mb-6 max-w-lg mx-auto" style={{ color: "#C0F0EE" }}>
            You get the same price booking through my link as you do booking direct. The difference is you get someone who knows the properties, understands what works for different family situations, and is available if anything comes up. Click below to start exploring.
          </p>
          <a
            href={AFFILIATE_LINK}
            target="_blank"
