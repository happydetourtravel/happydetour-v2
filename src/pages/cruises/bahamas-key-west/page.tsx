    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#F9FAFB", fontFamily: "sans-serif" }}>
      <div style={{ position: "relative", height: "480px", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: "1280px", margin: "0 auto", padding: "0 24px", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end", paddingBottom: "48px" }}>
          ...
          <h1 style={{ color: "white", fontSize: "42px", fontWeight: "800", margin: "0 0 12px 0", lineHeight: "1.2" }}>Caribbean Escape — Bahamas & Key West</h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: "48px", alignItems: "start" }}>
          <div>
            <div style={{ marginBottom: "48px" }}>
              ...
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: "0 0 16px 0" }}>Four nights is all it takes to remember why you needed this. The Scarlet Lady departs Miami and takes you to Key West — the kind of place where flip flops are formal wear — then on to Virgin's private Beach Club at Bimini in the Bahamas, where the water is so clear it doesn't look real.</p>
              <p style={{ color: "#4B5563", fontSize: "16px", lineHeight: "1.8", margin: 0 }}>This is a great first cruise. Short enough that it doesn't feel overwhelming, and packed enough that you'll come home already planning your next one. Everything Virgin includes is here: all specialty restaurants, WiFi, fitness classes, and non-alcoholic drinks. Gratuities are paid onboard separately.</p>
            </div>
          ...
          <div style={{ position: "sticky", top: "88px" }}>
            <div style={{ backgroundColor: "white", borderRadius: "16px", border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <a href="https://www.virginvoyages.com/book/voyage-planner/find-a-voyage?cabins=1&currencyCode=USD&agentId=278796&agencyId=589&bookingChannel=FMLINK&dateFrom=2027-01-01&dateTo=2027-01-31&durations=1-4" target="_blank" rel="noopener noreferrer" style={{ display: "block", textAlign: "center", backgroundColor: "#CC0000", color: "white", padding: "14px 16px", borderRadius: "8px", textDecoration: "none", fontWeight: "700", fontSize: "15px", marginBottom: "10px" }}>Book This Cruise</a>
                <div style={{ position: "relative", marginBottom: "12px" }}>
                  <button onClick={() => setContactOpen(!contactOpen)} style={{ display: "block", width: "100%", textAlign: "center", backgroundColor: "#F9FAFB", color: "#007298", padding: "12px 16px", borderRadius: "8px", fontWeight: "600", fontSize: "14px", border: "1px solid #E5E7EB", cursor: "pointer" }}>Contact Eric</button>
                  {contactOpen && (
                    <div style={{ position: "absolute", bottom: "100%", left: 0, right: 0, backgroundColor: "white", border: "1px solid #E5E7EB", borderRadius: "8px", boxShadow: "0 4px 16px rgba(0,0,0,0.1)", overflow: "hidden", marginBottom: "4px" }}>
                      <a href="sms:7473338687" style={{ display: "block", padding: "12px 16px", color: "#374151", textDecoration: "none", fontSize: "14px", borderBottom: "1px solid #F3F4F6" }}>Send a Text</a>
                      <a href="mailto:eric@happydetour.com" style={{ display: "block", padding: "12px 16px", color: "#374151", textDecoration: "none", fontSize: "14px" }}>Send an Email</a>
                    </div>
                  )}
                </div>
