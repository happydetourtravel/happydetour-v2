...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>My flight from Pittsburgh to JFK was supposed to leave at 6am. That got pushed back first.</p>

      <img src="/blog/flight-delay-board-2.jpeg" alt="Flight board showing PIT to JFK delayed to a 1:30pm departure" />
      <p class="caption">First delay of the day. Scheduled 6am departure, pushed to 1:30pm, landing 2:59pm.</p>

      <p>Then it got pushed back again.</p>

      <img src="/blog/flight-delay-board-1.jpeg" alt="Flight board showing PIT to JFK now departing 12:43pm" />
      <p class="caption">Second delay. Now departing 12:43pm and landing 2:12pm.</p>
