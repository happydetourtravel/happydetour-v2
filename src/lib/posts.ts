...
export const POSTS: Post[] = [
  ...
  {
    slug: 'my-6am-flight-just-became-a-130pm-flight',
    title: "My 6am Flight Just Became a 1:30pm Flight. Here's Why That's Exactly the Plan.",
    date: '2026-07-08',
    tag: 'Cruise Tips',
    ...
    image: '/blog/flight-delay-board-2.jpeg',
    content: `
      ...
      <p>A 6am flight is now a 1:30pm flight. This is not a hypothetical I am writing about after the fact. This is happening to me right now, in real time, sitting at that same gate.</p>
  ...
  },
{
  ...
  content: `
    ...
    <p>We also set a booking deadline. Book with a $500 deposit by August 22, 2026, and you get a fifty dollar onboard credit per cabin. That's money toward drinks, toward gratuities, toward whatever you want. You can still join the group anytime after that, right up until the final payment deadline of February 20, 2027, you just won't get that extra credit. It gives people a real reason to commit early instead of waiting until the last minute.</p>
